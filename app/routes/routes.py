...
from models.schemas.invoiceDetailSchema import InvoiceDetailSchema, Request, Response, RequestInvoiceDetail

import controllers.invoiceController as crud
...
@router.post("/create")
async def create_book_service(request: RequestInvoiceDetail, db: Session = Depends(get_db)):
...
@router.patch("/update")
async def update_book(request: RequestInvoiceDetail, db: Session = Depends(get_db)):
...
async def delete_book(request: RequestInvoiceDetail,  db: Session = Depends(get_db)):
